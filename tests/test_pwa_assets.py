...
class PwaAssetTests(unittest.TestCase):
    ...
    def test_briefing_items_open_first_citation_url(self) -> None:
        ...
        self.assertIn("supportsNativeShare()", app)
        self.assertIn("await navigator.share(", app)
        self.assertIn("data-share-title", app)
        self.assertIn("data-share-description", app)
        self.assertIn("data-share-url", app)
        self.assertIn("citation--button", app)
        self.assertIn("keydown", app)
        self.assertIn(".bullet[data-primary-url]", css)
        self.assertIn(".citation--button", css)
