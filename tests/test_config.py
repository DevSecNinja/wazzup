...
class ConfigTests(unittest.TestCase):
    def test_load_sources(self) -> None:
        ...
        self.assertIn("autoriteit-persoonsgegevens", {source.id for source in sources})
        self.assertIn("arnoud-engelfriet", {source.id for source in sources})
        ...
        self.assertEqual("https://autoriteitpersoonsgegevens.nl/nl/rss.xml", feed_url_by_id["autoriteit-persoonsgegevens"])
        self.assertEqual("https://blog.iusmentis.com/feed/", feed_url_by_id["arnoud-engelfriet"])
        self.assertGreaterEqual(weight_by_id["autoriteit-persoonsgegevens"], 1.2)
